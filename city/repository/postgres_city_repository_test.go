...
import (
	...
	"github.com/pragmaticivan/tinyestate-api/city/repository"
...
func TestFetch(t *testing.T) {
	...
	rows := sqlmock.NewRows([]string{"id", "name", "allows_on_wheels", "allows_on_foundation", "requires_care_giver", "created_at", "updated_at"}).
		AddRow(1, "Fresno", true, true, false, time.Now(), time.Now())
